...
const HeroSection = () => {
  return (
    <>
        ...
        <img src='../../public/blob2.gif' style={{position:"absolute",right:"-10%",width:"260px",top:"0"}} />
        <img src={image} />
        <div className='model-box' style={{left:"-20%",top:"50%"}}>Upload, classify, treat—achieve your best skin ever!</div>
        <div className='model-box' style={{right:"0%",top:"90%"}}>Get personalized acne care with just a photo!</div>
        <div className='model-box' style={{left:"-10%",top:"0%"}}>Detect, classify, and treat—your path to clearer skin.</div>
    ...
    <h1>01</h1>
    <h2>AI-Powered Acne <br/> Detection and Classification</h2>
    </div>
